...
const SECTORS = {
  ...
  'صناعة متنوعة':       ['GBCO','GDWA','DSCW','LCSW','NAPR','KABO','MICH','SPIN','ORWE'],
  'سيارات':             ['GBCO'],
...
//  ticker    price    chg%   capB    H52      L52     target  analyst   nameEn
  ...
  ['NAPR',    20.05,  -1.62,   4.3,   26.00,   5.00,   24.00, 'buy',   'National Printing'],
  ...
  ['PHGC',     0.079,  0.00,   1.9,    0.14,   0.02,    0.11, 'neutral','Premium Healthcare'],
